...
<button class="btn btn-danger" name="remove" value="<?= $supplier['id'] ?>">Remove</button>
</form>
</td>
</tr>
<?php
...
<form action="/admin/admin_panel.php" class="container d-flex mt-5 signupleo align-items-center mx-auto justify-content-center" method="POST">
    ...
    <div class="form-group col-3">
        <label for="exampleInputEmail1"style="font-family:Calibri">Название тренировки</label>
    ...
    <div class="form-group col-3">
        <label for="exampleInputEmail1"style="font-family:Calibri">Время</label>
    ...
    <div class="form-group col-3">
        <label for="exampleInputEmail1"style="font-family:Calibri">Дата</label>
        <input required type="date" class="form-control" name="data" id="exampleInputEmail1" aria-describedby="emailHelp value="<?php echo @$data['data'];?>"">
    </div>
    <div class="form-group col-3">
        <label for="exampleInputEmail1"style="font-family:Calibri">id тренера</label>
    ...
    <div class="form-group col-3">
        <label for="exampleInputEmail1"style="font-family:Calibri">имя</label>
    ...
    <button type="submit" name="do_add" class=" btn btn-primary"> Добавить занятие </button>
    <?php echo $log; ?>
</form>
